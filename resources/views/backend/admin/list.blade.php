...
@section('content')
  ...
  <div class="container">
    <div class="container-fluid">
        <h1 class="page-title">Filter Admin</h1>
                  ...
                  <form action="" method="get">
                        <div class="row">
                            ...
                            <select  class="form-control" name="role" id="">
                                ...
                                <option {{ (Request::get('role') == '1') ? 'selected' : '' }} value="1">Super Admin</option>
                                <option {{ (Request::get('role') == '2') ? 'selected' : '' }} value="2">Admin</option>
                            </select>
                            </div>
                            <div class="col-md-2">
      ...
      <div class="page-header mt-2">
        ...
        <div class="page-actions">
            ...
            <a href="{{url('panel/admin/create')}}" class="btn btn-primary">
                           ...
                           <tbody>
                            @forelse ($getRecord as $item)
                                <tr>
                                   ...
                                   <td >
                                       @if ($item->role == 1)
                                           <span class="label label-success text-primary">Super Admin</span>
                                       @else
                                           <span class="label label-warning text-success">Admin</span>
                                       @endif
                                   </td>
                                   <td >
                                       @if ($item->status == 1)
                                   ...
                                   <td>
                                      <a href="{{ url('panel/admin/edit', $item->id) }}" class="btn btn-primary btn-sm"><span class="fa fa-pencil"></span></a>
                                      <a href="{{ url('panel/admin/delete', $item->id) }}" onclick="return confirm('Are you sure do you want to delete ?');" class="btn btn-danger  btn-sm" ><span class="fa fa-times"></span></a>
                                   </td>
                                </tr>
                                @empty
                                <tr>
