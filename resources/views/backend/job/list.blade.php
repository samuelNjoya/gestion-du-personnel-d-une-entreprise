...
@section('content')
  ...
  <div class="container">
    <div class="container-fluid">
        <h1 class="page-title">Filter job</h1>
              ...
              <div class="panel-body">
                  ...
                  <form action="" method="get">
                        <div class="row">
                            ...
                            <a href="{{url('panel/job')}}" class="btn btn-success">Reset</a>
                            </div>
                        </div>
                </form>
      ...
      <div class="page-header mt-2">
        ...
        <div class="page-actions">
            ...
            <a href="{{url('panel/job/create')}}" class="btn btn-primary">
                           ...
                           <tbody>
                            @forelse ($getRecord as $item)
                                <tr>
                                   ...
                                   <td>
                                      <a href="{{ url('panel/job/edit', $item->id) }}" class="btn btn-primary btn-sm"><span class="fa fa-pencil"></span></a>
                                      <a href="{{ url('panel/job/delete', $item->id) }}" onclick="return confirm('Are you sure do you want to delete ?');" class="btn btn-danger  btn-sm" ><span class="fa fa-times"></span></a>
                                   </td>
                                </tr>
                                @empty
                                <tr>
